...
import { CREATIONS } from '../../constants/index.js';
...
const Creations = () => {
            ...
            setContent(
                  <>
                        <h1 className='pt-[1%] tracking-widest font-black text-center text-2xl text-red-600 '>
                              {creation.name}
                              <span className='absolute -translate-x-[99.95%] translate-y-[1%] font-semibold text-gray-300'> {creation.name} </span>
                              <span className='absolute -translate-x-[99%] translate-y-[2%] font-semibold text-black'> {creation.name} </span>
                        </h1>
                        ...
                        <div className='relative scale-[100%] -translate-y-[0%]'>
                              <div className="flex justify-center">
                                    <ReactPlayer url={creation.media} />
                              </div>
                        </div>
                  </>
            );
      ...
      return (
            <div>
                  ...
                  <Parallax ref={parallaxRef} pages={CREATIONS.length} className='bg-[url(https://w.wallhaven.cc/full/nm/wallhaven-nm9omy.jpg)]'>
                        {CREATIONS.map((creation, index) => (
                              <ParallaxLayer key={index} offset={index} factor={1} speed={.1} id={`creation-${index}`}>
                                    <div className='relative flex justify-center h-screen'>
                                          ...
                                          <div className='fixed origin-top left-[30%] top-[40%] w-[40%] h-[25%]'
                                                onClick={() => setupCreation(creation)}
